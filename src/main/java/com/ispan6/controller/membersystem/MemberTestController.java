...
//			System.out.println(filename);
	...
	public String insertMember(@ModelAttribute("memberTest") MemberTest mt,@RequestParam(value = "account") String account, @RequestParam(value = "password") String password, @RequestParam(value = "birth") Date birth, @RequestParam(value = "gender") int gender) {
		mt.setEmail(account);
