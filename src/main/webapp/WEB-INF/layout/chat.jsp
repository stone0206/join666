			...
			<div class="row">
				...
				<div class="chatImg">
					<c:if test="${loginUser==null }">
						...
						<a href="/login"><img
							src="${contextRoot}images/friendChat.png"
			...
			<div class="view-main">
				<div class="header-wrapp">
					...
					<div class="app-detail">
						<div>
							<img src="${loginUser.getAvator()}" alt="" style="width:90px;height:90px;border-radius:50%">
						</div>
						<div>Yousef Sami</div>
					...
					<div class="wave-wrapp">
						<svg class="wave" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g class="parallax">
                                <use xlink:href="#gentle-wave" x="50"
								y="0" fill="rgba(255, 255, 255, 0.48)" />
                                <use xlink:href="#gentle-wave" x="50"
								y="3" fill="rgba(255, 255, 255, 0.78)" />
                                <use xlink:href="#gentle-wave" x="50"
								y="6" fill="rgba(255, 255, 255, 0.8)" />
                            </g>
                        </svg>
					</div>
					<div id="closeFriendTable">
						<button data-widget="remove" id="removeClass1"
									...
									<div class="information">
										<div class="public">
											...
											<div class="form-group">
												...
												</span> <input type="text" placeholder="NAME" value="Yousef Sami">
											</div>
											<div class="form-group">
						...
						function() {
							...
							$(document)
									.on(
											...
											function(e) {
												var $ele = $(this);
												viewportY = (-1 * $ele.height())
														+ viewport($ele)
																.height();
												var startY = e.pageY
														|| e.originalEvent.touches[0].pageY;
												var currentY = parseFloat($ele
														.css('transform')
														.split(',')[5]);
												$(document)
														.on(
																...
																function(e) {
																	...
																	if (distY > 0
																		...
																		if (viewport(
																				$ele)
																				.find(
																						'.viewportShadow').length == 0)
																			viewport(
																					$ele)
																					.append(
																							'<span class="viewportShadow"></span>');
																	}
																	if (distY > 0) {
																		viewport(
																				$ele)
							...
							function sendMassage() {
								...
								$("#message-text").val("");
								var messageItem = "<li class='sent goto'><div>"
										+ message + "<span>" + getTime(date)
										+ "</span></div></li>";
