				...
				<form method="post" enctype="multipart/form-data" action="${contextRoot}/saveProduct">
					<div class="row" style="width: 85%;margin: 25px auto 0;">
						<c:forEach var="p" items="${product}">
							...
							<input type="hidden" name="sales" value="${p.sales}">
							<div class="col-6" style="padding: 20px;">
								<div style="text-align: center;">
									<img src="${p.img}" style="width: 286px;height: 286px;">
									<div>
							...
							<div class="col-6" style="padding: 20px;">
								...
								<h4 style="margin-bottom: 10px;"><input type="text" name="name" value="${p.name}"
										style="width: 100%;"></h4>
								...
								<div class="quantityBox title" style="display: flex;">
									<input id="quantityInput" type="text" name="inventory" value="${p.inventory}">
								</div>
								...
								<div class="desc title" style="margin-bottom: 20px;">
									<textarea name="desc" id="editor1" cols="54" rows="5">${p.desc }</textarea>
								</div>
						</c:forEach>
