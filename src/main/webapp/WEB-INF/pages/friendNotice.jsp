			...
			<div class="card">
				...
				<div class="card-footer mt-3 pt-2 pb-0">
					...
					<ul
						...
						<li class="nav-item"><a class="nav-link" onclick="getlist()"
							id="listbtn"> 好友列表 <span
								class="badge  bg-opacity-10 text-success small" id="friendlist">
							</span></a></li>
						<li class="nav-item"><a class="nav-link"
							onclick="sendinvitation()" id="sendbtn"> 已送出的邀請 <span
								class="badge  bg-opacity-10 text-success small" id="sendcount">
							</span></a></li>
						<li class="nav-item"><a class="nav-link" onclick="whosend()"
							id="getsendbtn"> 已收到的邀請 <span
								class="badge  bg-opacity-10 text-success small" id="getcount">
							</span></a></li>
						<li class="nav-item"><a class="nav-link"
							onclick="blocklist()" id="blockbtn"> 封鎖名單 <span
