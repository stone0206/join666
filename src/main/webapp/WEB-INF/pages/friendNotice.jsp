          ...
          <div class="h-200px rounded-top" style="background-image:url(assets/images/bg/05.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            ...
            <div class="card-footer mt-3 pt-2 pb-0">
              ...
              <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
              	<li class="nav-item"> <a class="nav-link" onclick="getlist()" id="listbtn"> 好友列表 <span class="badge  bg-opacity-10 text-success small" id="friendlist"> </span></a> </li>
                <li class="nav-item"> <a class="nav-link" onclick="sendinvitation()" id="sendbtn"> 已送出的邀請 <span class="badge  bg-opacity-10 text-success small" id="sendcount"> </span></a> </li>
                <li class="nav-item"> <a class="nav-link" onclick="whosend()" id="getsendbtn"> 已收到的邀請 <span class="badge  bg-opacity-10 text-success small" id="getcount"> </span></a> </li>
                <li class="nav-item"> <a class="nav-link" onclick="blocklist()" id="blockbtn"> 封鎖名單 <span class="badge  bg-opacity-10 text-success small" id="blockmember"></span> </a> </li>
              </ul>
            </div>
          </div>
          <!-- Card END -->
