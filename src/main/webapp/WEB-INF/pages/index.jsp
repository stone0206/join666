<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
							...
							<div class="card card-body">
								<div class="d-flex mb-3">
									...
									<div class="avatar avatar-xs me-2">
										<a href="#"> <img class="avatar-img rounded-circle" src="${loginUser.avator}"
												alt="">
										</a>
									</div>
									<!-- Post input -->
								...
								<ul class="nav nav-pills nav-stack small fw-normal">
									...
									<li class="nav-item dropdown ms-lg-auto"><a class="nav-link bg-light py-1 px-2 mb-0"
											href="#" id="feedActionShare" data-bs-toggle="dropdown"
		...
		<script type="text/javascript">
			function changeone() {
				fetch('${contextRoot}/newfriend').then(function (response) {
					...
					if (random.gender == 1) {
						changefriend += '<a>' + random.address + ',男</a>'
					}
					if (random.gender == 2) {
						changefriend += '<a>' + random.address + ',女</a>'
					}
					changefriend += '<div class="box"><p style="font-size: 40px;">' + random.name + '</p></div>'
					changefriend += '<div style="text-align: center;"><a style="font-size: 25px; margin: auto;"><button onclick="changeone()">換一個'
					changefriend += '</button></a> <a style="font-size: 25px; margin: auto;"><button>送出邀請</button></a></div></div>'
