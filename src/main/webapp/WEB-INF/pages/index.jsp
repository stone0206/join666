									...
									<div class="card card-body">
										<div class="d-flex mb-3">
											...
											<form:form modelAttribute="postBean" action="${contextRoot}/post"
												...
												<c:if test="${message.memberId.id !=loginUser.id}">
													<img src="${contextRoot}/assets/preview.png" style="width: 30px;"
												...
												<div class="card card-body mb-4 " style="background-color: AliceBlue;">
													...
													<div class="d-flex mb-3">
														...
														<c:if test="${loginUser ==null}">
															<div class="avatar avatar-xs me-2">
																<a href="#!"> <img class="avatar-img rounded-circle"
																		src="${contextRoot}/assets/avatar-placeholder.jpg"
																		alt="">
																</a>
															</div>
														</c:if>
															...
															<li class="comment-item" id="comment-${comment.commentid}">
																<div class="d-flex position-relative"
																	...
																	<div class="d-flex mb-3">
																		...
																		<!-- Comment by -->
																		<c:if
																			test="${message.memberId.id ==loginUser.id}">
																			<div
																				...
																				<div class="mb-1"
																					...
																					<small class="ms-2">
																						${comment.commenttime}</small>
																					<img src="${contextRoot}/assets/delete.png"
