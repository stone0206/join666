							...
							<div class="row g-4">
								<div class="col-lg-9" style="margin-top: 60px">
									<div class="card card-body">
											...
											<%-- <form:form modelAttribute="postBean" --%>
												<%-- action="${contextRoot}/post"> --%>
													...
													<%-- <form class="w-100"> --%>
														...
														<!-- 																	class="form-control pe-4 border-0" rows="3" -->
														<!-- 																	cols="100" data-autoresize -->
										...
										<!-- 														<li class="nav-item"><a class="nav-link bg-light py-1 px-2 mb-0" -->
															...
															<div>
																<div class="nav nav-divider">
																	<h6 class="nav-item card-title mb-0">
																		...
																		<div>&nbsp;&nbsp;&nbsp;</div><br>
																		<div style="width:600px;style=" font-size:12px
																			;text-align:right; background: AliceBlue;">
																			Time
																			<fmt:formatDate
												...
												<div class="card-body" id="onefriend">
													...
													<div style="text-align: center;">
														<a style="font-size: 25px; margin: auto;"><button
															...
															style="font-size: 25px; margin: auto;"><button id="addBtn"
