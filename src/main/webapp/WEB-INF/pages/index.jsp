              ...
              <div class="card card-body">
                <div class="d-flex mb-3">
                  ...
                  <div class="avatar avatar-xs me-2">
                    <a href="#"> <img class="avatar-img rounded-circle" src="${loginUser.avator}" alt="">
                    </a>
                  </div>
                  <!-- Post input -->
                  <form modelAttribute="postBean" action="${contextRoot}/post" method="post">
                    <textarea name="content" class="form-control pe-4 border-0" rows="3" cols="100" data-autoresize
                    ...
                    <div class="card-header border-0 pb-0">
                      <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                          <!-- Avatar -->
                          <div class="avatar">
                            <a href="#!"> <img class="avatar-img rounded-circle" src="${loginUser.getAvator()}" alt="">
                            </a>
                          </div>
                          <!-- Info -->
                          <div>
                            <div class="nav nav-divider">
                              <h6 class="nav-item card-title mb-0">
                                ...
                                <div>&nbsp;&nbsp;&nbsp;</div><br>
                                <div style="width:600px;style=" font-size:12px ;text-align:right; background:
                                  AliceBlue;">
                                  Time
                                  <fmt:formatDate pattern="yyy/MM/dd HH:mm:ss EEEE" value="${message.posttime}" />
                      ...
                      <%-- ${message.content}</p> --%>
                        ...
                        <ul class="nav nav-stack py-3 small">
                          ...
                          <li class="nav-item"><a class="nav-link" href="#!">
                              <i class="bi bi-chat-fill pe-1"></i>留言數(誰留言)
                            </a></li>
                ...
                <div class="col-sm-6 col-lg-12" style="margin-top: 60px">
                  <div class="card">
                    ...
                    <div class="card-body" id="onefriend">
                      <div>
                        <a role="button" data-bs-auto-close="outside"> <img class="avatar-img" src="${random.avator}"
                      ...
                      <div style="text-align: center;">
                        <a style="font-size: 25px; margin: auto;"><button onclick="changeone()">換一個</button></a>
                        <c:if test="${loginUser ==null}">
                          <a style="font-size: 25px; margin: auto;" href="/login"><button id="addBtn">請先登入</button></a>
                        </c:if>
                        <c:if test="${loginUser !=null}">
                          <a style="font-size: 25px; margin: auto;" id="logina"><button id="addBtn"
                              onclick="addNewFriend(${random.id})">
                              送出邀請</button></a>
                        </c:if>
                    ...
                    <c:if test="${loginUser ==null}">
                      <div class="d-grid mt-3">
                        <a class="btn btn-sm btn-primary-soft" href="/login" style="font-size: 20px;">更多推薦</a>
                      </div>
                    </c:if>
                    <c:if test="${loginUser !=null}">
                      <div class="d-grid mt-3">
                        <a class="btn btn-sm btn-primary-soft" href="/addfriend" style="font-size: 20px;">更多推薦</a>
                      </div>
                    </c:if>
                  </div>
                  <!-- Card body END -->
