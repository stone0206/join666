					...
					<div class="container-fluid" style="width: 85%;">
						<div class="row">
							<div class="col-12" style="height: 400px;margin-bottom: 5px; padding: 10px;">
								<div style="height: 30px;"><img src="/assets/matchpage.webp"style="height:360px; width:1600px;"></div>
							</div>
						</div>
						<div class="row">
							<!-- 左側邊欄 -->
								...
								<div id="query" style="background-color: white;">
									...
									<div>
										...
										<form action="/" method="post">
											<input type="text" style="width: 60px;" placeholder="" id="lP"> 一 <input
												type="text" style="width: 60px; margin-right: 10px;" placeholder=""
							...
							<div class="col-9">
								<div class="row">
									...
									<!-- 排序 -->
									<input id="login" value="${hobbit}" hidden="true"/>
								</div>
